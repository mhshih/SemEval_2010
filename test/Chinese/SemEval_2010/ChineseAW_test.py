...
#   synset_gloss=read_cwn_synset_gloss(cwn)
...
from cwn_16 import read_cwn_synset_gloss,read_cwn_lemma_synsets

if __name__=='__main__':
    cwnfile='cwn_16.xml'
    synset_gloss=read_cwn_synset_gloss(cwnfile)
    lemma_synsets=read_cwn_lemma_synsets(cwnfile)
...
#           print(word,synset_id)#,sep='\t',end='\t')
            if synset_id:
                ...
                for synset in lemma_synsets[word]:
                    print('',synset,synset_gloss[synset],sep='\t')
#           else:print()
